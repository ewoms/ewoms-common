 ...
 */
#ifndef EWOMS_MATERIAL_MATH_TOOLBOX_HH
#define EWOMS_MATERIAL_MATH_TOOLBOX_HH
...
public:
     ...
     */
    typedef Ewoms::MathToolbox<Scalar> InnerToolbox;
     ...
     */
    static Scalar createBlank(Scalar value EWOMS_UNUSED)
    { return Scalar(); }
     ...
     * are zero.
     */
    static Scalar createConstant(Scalar x EWOMS_UNUSED, Scalar value)
    { return value; }
     ...
     * nothing.
     */
    static Scalar createVariable(Scalar value EWOMS_UNUSED, unsigned varIdx EWOMS_UNUSED)
     ...
     * nothing.
     */
    static Scalar createVariable(Scalar x EWOMS_UNUSED, Scalar value EWOMS_UNUSED, unsigned varIdx EWOMS_UNUSED)
    { throw std::logic_error("Plain floating point objects cannot represent variables"); }
...
{ return Ewoms::MathToolbox<Evaluation>::createBlank(x); }

template <class Evaluation, class Scalar>
Evaluation constant(const Scalar& value)
{ return Ewoms::MathToolbox<Evaluation>::createConstant(value); }

template <class Evaluation, class Scalar>
Evaluation constant(unsigned numDeriv, const Scalar& value)
{ return Ewoms::MathToolbox<Evaluation>::createConstant(numDeriv, value); }

template <class Evaluation, class Scalar>
Evaluation constant(const Evaluation& x, const Scalar& value)
{ return Ewoms::MathToolbox<Evaluation>::createConstant(x, value); }

template <class Evaluation, class Scalar>
Evaluation variable(unsigned numDeriv, const Scalar& value, unsigned idx)
{ return Ewoms::MathToolbox<Evaluation>::createVariable(numDeriv, value, idx); }

template <class Evaluation, class Scalar>
Evaluation variable(const Evaluation& x, const Scalar& value, unsigned idx)
{ return Ewoms::MathToolbox<Evaluation>::createVariable(x, value, idx); }

template <class Evaluation, class Scalar>
Evaluation variable(const Scalar& value, unsigned idx)
{ return Ewoms::MathToolbox<Evaluation>::createVariable(value, idx); }

template <class ResultEval, class Evaluation>
auto decay(const Evaluation& value)
    -> decltype(Ewoms::MathToolbox<Evaluation>::template decay<ResultEval>(value))
{ return Ewoms::MathToolbox<Evaluation>::template decay<ResultEval>(value); }

template <class Evaluation>
auto getValue(const Evaluation& val)
    -> decltype(Ewoms::MathToolbox<Evaluation>::value(val))
{ return Ewoms::MathToolbox<Evaluation>::value(val); }

template <class Evaluation>
auto scalarValue(const Evaluation& val)
    -> decltype(Ewoms::MathToolbox<Evaluation>::scalarValue(val))
{ return Ewoms::MathToolbox<Evaluation>::scalarValue(val); }
...
{ return Ewoms::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::max(arg1, arg2); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
min(const Evaluation1& arg1, const Evaluation2& arg2)
{ return Ewoms::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::min(arg1, arg2); }

template <class Evaluation>
Evaluation abs(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::abs(value); }

template <class Evaluation>
Evaluation tan(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::tan(value); }

template <class Evaluation>
Evaluation atan(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::atan(value); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
atan2(const Evaluation1& value1, const Evaluation2& value2)
{ return Ewoms::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::atan2(value1, value2); }

template <class Evaluation>
Evaluation sin(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::sin(value); }

template <class Evaluation>
Evaluation asin(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::asin(value); }

template <class Evaluation>
Evaluation cos(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::cos(value); }

template <class Evaluation>
Evaluation acos(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::acos(value); }

template <class Evaluation>
Evaluation sqrt(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::sqrt(value); }

template <class Evaluation>
Evaluation exp(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::exp(value); }

template <class Evaluation>
Evaluation log(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::log(value); }

template <class Evaluation>
Evaluation log10(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::log10(value); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
pow(const Evaluation1& base, const Evaluation2& exp)
{ return Ewoms::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::pow(base, exp); }

template <class Evaluation>
bool isfinite(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::isfinite(value); }

template <class Evaluation>
bool isnan(const Evaluation& value)
{ return Ewoms::MathToolbox<Evaluation>::isnan(value); }
