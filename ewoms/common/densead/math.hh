 ...
 * \file
 *
 * \brief A number of commonly used algebraic functions for the localized automatic
 *        differentiation (AD) framework.
 *
 * This file provides AD variants of the the most commonly used functions of the <cmath>
 * header file.
 */
#ifndef EWOMS_LOCAL_AD_MATH_HH
#define EWOMS_LOCAL_AD_MATH_HH
...
// scalar case is provided by the mathtoolbox.hh header file.)
template <class ValueT, int numVars, unsigned staticSize>
struct MathToolbox<Ewoms::DenseAd::Evaluation<ValueT, numVars, staticSize> >
{
private:
public:
    typedef ValueT ValueType;
    typedef Ewoms::MathToolbox<ValueType> InnerToolbox;
    typedef typename InnerToolbox::Scalar Scalar;
    typedef Ewoms::DenseAd::Evaluation<ValueType, numVars, staticSize> Evaluation;
