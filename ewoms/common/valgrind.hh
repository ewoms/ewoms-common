...
#if HAVE_VALGRIND
#define EWOMS_VALGRIND_OPTIM_UNUSED EWOMS_OPTIM_UNUSED
#else
#define EWOMS_VALGRIND_OPTIM_UNUSED EWOMS_UNUSED
#endif
 ...
 */
template <class T>
inline bool CheckDefined(const T& value EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline bool CheckAddressable(const T& value EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline bool CheckDefined(const T* value EWOMS_VALGRIND_OPTIM_UNUSED, int size EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetUndefined(const T &value EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetUndefined(const T* value EWOMS_VALGRIND_OPTIM_UNUSED, int size EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetDefined(const T& value EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetDefined(const T *value EWOMS_VALGRIND_OPTIM_UNUSED, int n EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetNoAccess(const T &value EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
 ...
 */
template <class T>
inline void SetNoAccess(const T *value EWOMS_VALGRIND_OPTIM_UNUSED, int size EWOMS_VALGRIND_OPTIM_UNUSED)
{
#if !defined NDEBUG && HAVE_VALGRIND
