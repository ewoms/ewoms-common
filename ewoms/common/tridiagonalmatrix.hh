...
/*!
 * \file
 * \copydoc Ewoms::TridiagonalMatrix
 */
#ifndef EWOMS_TRIDIAGONAL_MATRIX_HH
#define EWOMS_TRIDIAGONAL_MATRIX_HH
...
template <class Scalar>
std::ostream& operator<<(std::ostream& os, const Ewoms::TridiagonalMatrix<Scalar>& mat)
{
    mat.print(os);
    return os;
}
