...
#define PROP_INFO_(EffTypeTagName, PropKind, PropTagName, ...)          \
    ...
    static const int foo_ ## PropTagName EWOMS_UNUSED  =                  \
...
#define TTAG_INFO_(TagName, ...)                                        \
    ...
    static const int fooTypeTagInfo_ ## TagName EWOMS_UNUSED =            \
...
#define SPLICE_INFO_(SpliceName, ...)                                   \
    ...
    static const int fooSpliceInfo_ ## SpliceName EWOMS_UNUSED =          \
