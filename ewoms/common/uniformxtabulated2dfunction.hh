 ...
 * \file
 *
 * \copydoc Ewoms::UniformXTabulated2DFunction
 */
#ifndef EWOMS_UNIFORM_X_TABULATED_2D_FUNCTION_HH
#define EWOMS_UNIFORM_X_TABULATED_2D_FUNCTION_HH
...
public:
    ...
    unsigned xSegmentIndex(const Evaluation& x, bool extrapolate EWOMS_OPTIM_UNUSED = false) const
    {
     ...
     */
    template <class Evaluation>
    unsigned ySegmentIndex(const Evaluation& y, unsigned xSampleIdx, bool extrapolate EWOMS_OPTIM_UNUSED = false) const
    {
    ...
    bool applies(const Evaluation& x, const Evaluation& y) const
    {
        ...
        Scalar alpha = xToAlpha(Ewoms::decay<Scalar>(x), i);
     ...
     * range, a \c Ewoms::NumericalIssue exception is thrown.
     */
    template <class Evaluation>
